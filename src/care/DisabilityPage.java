 ...
 * @author SAIF
 */
public class DisabilityPage extends javax.swing.JFrame {
...
//sets column width
    ...
    public DisabilityPage(String username){
        this.user = username;
        initComponents();
        this.setLocationRelativeTo(null);
...
//sets column width
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DisabilityPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DisabilityPage().setVisible(true);
            }
        });
    }
