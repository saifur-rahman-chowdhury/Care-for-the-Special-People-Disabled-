 ...
 * @author SAIF
 */
public class PatientSignInPage extends javax.swing.JFrame {

    /**
     * Creates new form PatientSignInPage
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(patient, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 180, 100, 110));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientSignInPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PatientSignInPage().setVisible(true);
            }
        });
    }
