 ...
 * @author SAIF
 */
public class OthersProfilePage extends javax.swing.JFrame {

    /**
     * Creates new form OthersProfilePage
     */
    ...
    public OthersProfilePage(String username){
        initComponents();
        this.setLocationRelativeTo(null);
            conn = DatabaseHandler.connectDatabase1();
        try{
            String sql ="SELECT * FROM others where username ='"+username+"'";
    ...
    private void initComponents() {
        ...
        getContentPane().add(updatebutton, new org.netbeans.lib.awtextra.AbsoluteConstraints(180, 640, -1, -1));

        background.setIcon(new javax.swing.ImageIcon("C:\\Users\\SAIF\\Desktop\\background_light_blur_68629_1920x1080.jpg")); // NOI18N
        background.setText("background");
        background.setPreferredSize(new java.awt.Dimension(1230, 760));
    ...
    private void backbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_backbuttonActionPerformed
        ...
        OthersSignInPage osp= new OthersSignInPage();
        osp.setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OthersProfilePage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OthersProfilePage().setVisible(true);
            }
        });
    }
