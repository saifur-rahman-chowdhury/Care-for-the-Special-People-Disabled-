 ...
 * @author SAIF
 */
public class OthersRegistrationPage extends javax.swing.JFrame {

    /**
     * Creates new form OthersRegistrationPage
     */
    public OthersRegistrationPage() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(others, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 100, -1));
        ...
        informationtitle.setText("OTHERS INFORMATION");
    ...
    private void signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupActionPerformed
        ...
        if( !(firstnamefield.getText().equals("")) && !(lastnamefield.getText().equals("")) && !(usernamefield.getText().equals(""))&& !(passwordfield.getText().equals(""))&& !(reenterpasswordfield.getText().equals(""))&& !(genderfield.getSelectedItem().equals(""))){
            ...
            db.othersinsertData(firstnamefield.getText(),lastnamefield.getText(),usernamefield.getText(),passwordfield.getText(),reenterpasswordfield.getText(),g,d,jTextArea1.getText(),mobilenofield.getText());
            firstname.setText("");
            lastname.setText("");
            username.setText("");
            password.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OthersRegistrationPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OthersRegistrationPage().setVisible(true);
            }
        });
    }
