 ...
 * @author SAIF
 */
public class OthersSignInPage extends javax.swing.JFrame {

    /**
     * Creates new form OthersSignInPage
     */
    Connection conn = null;
    PreparedStatement pst = null;
    ResultSet rs = null;
    public OthersSignInPage() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(others, new org.netbeans.lib.awtextra.AbsoluteConstraints(570, 180, 100, 110));
        ...
        // TODO add your handling code here:
            ...
            try{
                ...
                if(rs.next()){
                    ...
                    this.setVisible(false);
                    OthersProfilePage opp = new OthersProfilePage(user); 
                    opp.setVisible(true);
                }
                else{
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OthersSignInPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OthersSignInPage().setVisible(true);
            }
        });
    }
