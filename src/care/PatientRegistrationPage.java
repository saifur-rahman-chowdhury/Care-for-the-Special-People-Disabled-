 ...
 * @author SAIF
 */
public class PatientRegistrationPage extends javax.swing.JFrame {

    /**
     * Creates new form PatientRegistrationPage
     */
    ...
    private void signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupActionPerformed
        ...
        if( !(firstnamefield.getText().equals("")) && !(lastnamefield.getText().equals("")) && !(usernamefield.getText().equals(""))&& !(passwordfield.getText().equals(""))&& !(reenterpasswordfield.getText().equals(""))&& !(genderfield.getSelectedItem().equals(""))){
         /*  try{
            ...
            String selectQuery = "SELECT count(*) from patient where username ='"+u+"'";
        ...
        if(rs.next()){
           ...
           // db.test("usernamefield.getText()");
            ...
            db.patientinsertData(firstnamefield.getText(),lastnamefield.getText(),usernamefield.getText(),passwordfield.getText(),reenterpasswordfield.getText(),g,d,jTextArea1.getText(),mobilenofield.getText(),jTextArea2.getText());
            firstname.setText("");
            lastname.setText("");
            username.setText("");
            password.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PatientRegistrationPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
