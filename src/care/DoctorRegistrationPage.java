 ...
 * @author SAIF
 */
public class DoctorRegistrationPage extends javax.swing.JFrame {

    /**
     * Creates new form DoctorRegistrationPage
     */
    ...
    private void initComponents() {
        ...
        getContentPane().add(title, new org.netbeans.lib.awtextra.AbsoluteConstraints(290, 50, 710, 60));
        ...
        doctor.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        getContentPane().add(doctor, new org.netbeans.lib.awtextra.AbsoluteConstraints(110, 160, 100, -1));
        ...
        getContentPane().add(informationtitle, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 270, -1, -1));
        ...
        getContentPane().add(departmentfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 660, 210, -1));

        department.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        department.setForeground(new java.awt.Color(204, 255, 255));
        department.setText("DEPARTMENT");
        getContentPane().add(department, new org.netbeans.lib.awtextra.AbsoluteConstraints(450, 660, -1, -1));
        getContentPane().add(hospitalfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 700, 210, -1));

        hospital.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
        hospital.setForeground(new java.awt.Color(204, 255, 255));
        hospital.setText("HOSPITAL");
        getContentPane().add(hospital, new org.netbeans.lib.awtextra.AbsoluteConstraints(480, 700, -1, -1));

        background.setFont(new java.awt.Font("Tahoma", 1, 16)); // NOI18N
    ...
    private void signupActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_signupActionPerformed
        ...
        if( !(firstnamefield.getText().equals("")) && !(lastnamefield.getText().equals("")) && !(usernamefield.getText().equals(""))&& !(passwordfield.getText().equals(""))&& !(reenterpasswordfield.getText().equals(""))&& !(genderfield.getSelectedItem().equals(""))){
            ...
            db.doctorinsertData(firstnamefield.getText(),lastnamefield.getText(),usernamefield.getText(),passwordfield.getText(),reenterpasswordfield.getText(),g,d,jTextArea1.getText(),mobilenofield.getText());
            firstname.setText("");
            lastname.setText("");
            username.setText("");
            password.setText("");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(DoctorRegistrationPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new DoctorRegistrationPage().setVisible(true);
            }
        });
    }
