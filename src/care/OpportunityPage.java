 ...
 * @author SAIF
 */
public class OpportunityPage extends javax.swing.JFrame {

    /**
     * Creates new form OpportunityPage
     */
    ...
    public OpportunityPage() {
        ...
        opportunityfield.setBackground(new Color(0,0,0,0));
        
        opportunityfield.setOpaque(false);
         jTable1.setOpaque(false);
            ((DefaultTableCellRenderer)jTable1.getDefaultRenderer(String.class)).setOpaque(false);
            
        opportunityfield.getViewport().setOpaque(false);
...
//sets column width
 ...
 public OpportunityPage(String username) {
     this.user = username;
        initComponents();
        this.setLocationRelativeTo(null);
...
//sets column width
    ...
    private void initComponents() {
        ...
        opportunityfield = new javax.swing.JScrollPane();
        ...
        opportunityfield.setViewportView(jTable1);

        getContentPane().add(opportunityfield, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 250, 890, 430));
     ...
     public ArrayList<OpportunityInfo> opportunityList(){
        ArrayList<OpportunityInfo> opportunitiesList = new ArrayList<>();
         conn = DatabaseHandler.connectDatabase1();
         try{
             String query = "SELECT * FROM opportunity";
             Statement st = conn.createStatement();
             ResultSet rs = st.executeQuery(query);
             OpportunityInfo info;
             while(rs.next()){
                 info = new OpportunityInfo(rs.getString("dis_name"),rs.getString("details"),rs.getString("type"));
                 opportunitiesList.add(info);
             }
         }
         catch(Exception e){
    ...
    public void show_info(){
        ArrayList<OpportunityInfo> list = opportunityList();
        DefaultTableModel model  = (DefaultTableModel)jTable1.getModel();
        Object[] row = new Object[6];
        for(int i=0;i<list.size();i++){
            row[0] = list.get(i).getname();
            row[1] = list.get(i).getdetails();
    ...
    private void searchbuttonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_searchbuttonActionPerformed
        // TODO add your handling code here:
        try{
            String query = "SELECT * FROM opportunity WHERE disability = ?";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OpportunityPage.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new OpportunityPage().setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JScrollPane opportunityfield;
